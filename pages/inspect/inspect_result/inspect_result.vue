<template>
	<view class="collect_content">
		<u-form :model="form" ref="uForm">
			...
			<u-form-item label="被采集者信息" label-width="250rpx">
			</u-form-item>
			...
			<u-form-item label="联系电话" :required="true" label-width="150rpx">
			...
			<u-form-item label="是否发热" label-width="150rpx">
				<u-input v-model="form.hot" disabled="true" />
			</u-form-item>
		</u-form>
		<!-- 上传图片、文件 -->
		<upload @upload="uploadFile" ref="msg"></upload>
